### Este código é uma adaptação, o código original está disponível no seguinte repositório:
 This code is an adaptation, the original code is avaliabe in the following repository:
